...
export function App() {
  ...
  return (
    <div className="app">
      ...
      {(view === 'action' || view === 'agenda' || view === 'strategy' || view === 'public_objective' || view === 'secret_objective' || view === 'legendary_planet' || view === 'exploration' || view === 'faction_ability' || view === 'faction_leader') && (
        <CategoryView
          cards={cards}
          category={view}
          onBack={() => setView('home')}
